...
const EditProductAdminModal = ({
  ...
  const [data, setData] = useState({
    ...
    discount: editProductData?.discount || 0,
    description: editProductData?.description || "",
    more_details: editProductData?.more_details || {},
  });
    ...
    <section className="px-4 pl-4 pr-4">
      <dialog ref={modalRef} id="my_modal_2" className="modal modal-middle">
        <div className="modal-box ">
          <div className="p-3 bg-white rounded-lg shadow-md shadow-neutral-300 mb-4 ">
            <h1 className="font-semibold  lg:text-xl flex items-center justify-between text-green-700 uppercase text-md ">
              Edit Product
              <button
                ...
                <div>
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      // if (!data.category.find((c) => c._id === value)) {
                      //   setData((prev) => ({
                      //     ...prev,
                      //     category: [...prev.category, categoryDetails],
                      //   }));
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className="cursor-pointer hover:text-red-600"
                          onClick={() =>
                            handleRemoveSubCategorySelected(item._id)
                          }
                        >
                          <IoClose size={15} />
                        </div>
